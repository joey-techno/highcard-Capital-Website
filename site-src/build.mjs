...
const PAGES = [
  ...
  { file: 'how-it-works.html',   body: 'how-it-works.html', id: 'how', nav: 'how',
    title: 'How It Works · From Hello to Funded, Options by Tomorrow | High Card Capital',
    desc: 'Three steps: a two-minute application, a real advisor calling with real numbers within 24–48 hours, and funds wired to your account. Here is exactly what happens after you apply.' },
