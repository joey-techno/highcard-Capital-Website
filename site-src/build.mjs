...
const PAGES = [
  ...
  { file: 'services.html',       body: 'services.html', id: 'services', nav: 'funding',
    title: 'Services · Six Ways to Fund the Next Move | High Card Capital',
    desc: 'Term Loans, SBA Loans, HELOC, Line of Credit, Equipment Financing, and Revenue Based Financing. One five minute application prices every option. No cost, no obligation.' },
  { file: 'industries.html',     body: 'industries.html', id: 'industries', nav: 'industries',
    title: 'Industries We Fund · Funding Shaped to Your Trade | High Card Capital',
    desc: 'Restaurants, construction, trucking, retail, medical, and more. Funding shaped to how your industry actually earns. One five minute application, no cost, no obligation.' },
  ...
  { file: 'equipment-financing.html', body: 'equipment-financing.html', id: 'equipment', nav: 'funding',
    title: 'Equipment Financing · Up to 100% of the Cost, New and Used | High Card Capital',
    desc: 'Finance new or used equipment and spread the cost over its working life. No minimum FICO, up to 100% of the cost covered, and options in less than 24 hours.' },
  { file: 'revenue-financing.html', body: 'revenue-financing.html', id: 'rbf', nav: 'funding',
    title: 'Revenue Based Financing · 1 to 3x Monthly Revenue | High Card Capital',
    desc: 'Turn your sales into working capital with funding sized 1 to 3 times your monthly revenue. No minimum FICO, early payoff discounts, and options in less than 24 hours.' },
  { file: 'sba-loans.html',      body: 'sba-loans.html', id: 'sba',   nav: 'funding',
    title: 'SBA Loans · $25K to $15M, Terms up to 25 Years | High Card Capital',
    desc: 'Government backed funding from $25K to $15M with terms of 10 to 25 years and payments that stay small. 650 minimum FICO, options in 1 to 4 weeks, and we handle the paperwork start to finish.' },
  { file: 'heloc.html',          body: 'heloc.html',   id: 'heloc',   nav: 'funding',
    title: 'HELOC for Business Owners · Up to 90% CLTV, 7 to 11% APR | High Card Capital',
    desc: 'Turn your home equity into revolving business capital, up to 90% CLTV at 7 to 11% APR. No appraisal, soft credit pull, 620 minimum FICO, and closings in as fast as 5 days.' },
  { file: 'line-of-credit.html', body: 'line-of-credit.html', id: 'loc', nav: 'funding',
    title: 'Business Line of Credit · $10K to $5M, Draw · Repay · Redraw | High Card Capital',
